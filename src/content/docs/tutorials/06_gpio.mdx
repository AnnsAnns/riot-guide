...
import ButtonVideo from './img/06_gpio/08_buttons.mp4';
...
![The board variable in Visual Studio Code](img/06_gpio/01_define_board.png)
...
![Flash output in Visual Studio Code](img/06_gpio/02_flash_output.png)
...
![The Makefile with the GPIO modules](img/06_gpio/03_gpio_modules.png)
...
![The Code in Visual Studio Code](img/06_gpio/04_code.png)
...
![Full Code in Visual Studio Code](img/06_gpio/07_full_code.png)
