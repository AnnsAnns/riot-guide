...
![The Makefile in Visual Studio Code](img/04_shell/01_makefile.png)
...
![The shell prompt](img/04_shell/02_shell.png)
...
![The echo command in action](img/04_shell/03_echo.png)
