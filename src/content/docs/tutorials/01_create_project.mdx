...
![The output of the git init command](img/01_create_project/01_empty_git.png)
...
![Adding the submodule](img/01_create_project/02_riot_submodule.png)
...
![The hello world program in Visual Studio Code](img/01_create_project/03_main_c.png)
...
![The Makefile in Visual Studio Code](img/01_create_project/04_makefile.png)
...
![Building the program](img/01_create_project/05_make.png)
...
![The hello world program running in the RIOT shell](img/01_create_project/06_output.png)
