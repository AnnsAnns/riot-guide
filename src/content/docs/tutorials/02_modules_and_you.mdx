---
title: 02. Finding and Using Modules
...
`ztimer` is one of the core modules in RIOT and provides a way to work with timers. both software and hardware timers are supported.
...
![API Documentation Website](img/02_modules/01_api_doc.png)
...
![RIOT Examples](img/02_modules/02_examples.png)
...
![RIOT Source Code](img/02_modules/03_source.png)
...
Now that we know where to find modules, let's take a look at how we can use them in our application.