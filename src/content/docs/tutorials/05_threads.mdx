...
![The thread function in Visual Studio Code](img/05_threads/01_thread_function.png)
...
:::caution
You need to specify `void *arg` even if you don't use it, otherwise the compiler will throw an error.
:::
...
![The thread stack in Visual Studio Code](img/05_threads/02_stack.png)
...
![The output](img/05_threads/03_output.png)
...
:::note
The source code for this tutorial can be found [HERE](https://github.com/AnnsAnns/RIOT-Tutorial-Repository/tree/05_threads). 
