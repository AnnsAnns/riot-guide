...
[PWM1_GPIOS](#esp32_pwm_channels)|GPIOs that can be used at channels of [PWM_DEV(1)](./doc/starlight-docs/src/content/docs/apidoc/api-undefined.md#group__drivers__periph__pwm_1gad7999c048ca3b0783f3fb62b93b056db)|o
...
Features of The ESP32-C3 SoC variant (family)The key features of ESP32-C3 are:
...
[Timer](./doc/starlight-docs/src/content/docs/apidoc/api-pkg_paho_mqtt.md#structTimer)|2 x 54 bit   |yes
...
Crypto   |Hardware acceleration of AES, SHA-2, RSA, ECC, RNG   |no
Vcc   |3.0 - 3.6 V   |
Documents   |[Datasheet](https://www.espressif.com/sites/default/files/documentation/esp32-c3_datasheet_en.pdf)[Technical Reference](https://www.espressif.com/sites/default/files/documentation/esp32-c3_technical_reference_manual_en.pdf)|

Features of The ESP32-S2 SoC variant (family)The key features of ESP32-S2 are:
...
With the function [adc_set_attenuation](./doc/starlight-docs/src/content/docs/apidoc/api-undefined.md#adc__arch_8h_1a99ad2f6a0bdea91f7ca3102e5f67fb85) an attenuation of the input signal can be defined separately for each ADC channel. 
```cpp
...
* [ESP32](#group__cpu__esp32__esp32_1esp32_pwm_channels_esp32)
...
where the value of [SDMMC_NUMOF](./doc/starlight-docs/src/content/docs/apidoc/api-undefined.md#group__drivers__sdmmc_1ga933a86268a5bd605c19091dbf12b340f) must correspond to the number of elements in [sdmmc_config](./doc/starlight-docs/src/content/docs/apidoc/api-undefined.md#boards_2stm32l496g-disco_2include_2periph__conf_8h_1a08cad2d5b5be3a456b03795de581a5a9).
...
* `SPIn_MOSI`, the GPIO used as MOSI signal used for [SPI_DEV(n)](./doc/starlight-docs/src/content/docs/apidoc/api-undefined.md#group__drivers__periph__spi_1gafb9420809bc7722e41488a090b53eaf9), and
...
* `UARTn_TXD`, the GPIO used as TxD signal for [UART_DEV(n)](./doc/starlight-docs/src/content/docs/apidoc/api-undefined.md#group__drivers__periph__uart_1gafc5afd63560d27731d2517b3005f3294), and
...
* In **Deep-sleep** the CPU and the SRAM are powered down. The RTC memory can be retained. The system must be restarted when it returns from this mode.
...
Make Variable CFLAGSUsing the `CFLAGS` make variable at the command line, board or driver parameter definitions can be overridden.
...
DebuggingJTAG DebuggingESP32x SoCs integrate a JTAG interface for On-Chip Debugging. The GPIOs connected to this JTAG interface depend on the ESP32x SoC variant (family). For details, see:

* [ESP32](#group__cpu__esp32__esp32_1esp32_jtag_interface_esp32)

* [ESP32-C3](#group__cpu__esp32__esp32c3_1esp32_jtag_interface_esp32c3)

* [ESP32-S2](#group__cpu__esp32__esp32s2_1esp32_jtag_interface_esp32s2)

* [ESP32-S3](#group__cpu__esp32__esp32s3_1esp32_jtag_interface_esp32s3)
...
Some ESP32 boards like the [ESP-WROVER-KIT V3](#group__boards__esp32__esp-wrover-kit_1esp32_wrover_kit_toc) or the [ESP32-Ethernet-Kit ](#group__boards__esp32__esp-ethernet-kit-v1__0_1esp32-ethernet-kit-v1_0) have a USB bridge with JTAG interface on-board that can be directly used for JTAG debugging.
...
To use the JTAG debugging, the precompiled version of OpenOCD for ESP32 has to be installed using the toolchain install script while being in RIOT's root directory, see also section [Using Local Toolchain Installation](#esp32_local_toolchain_installation). 
```cpp
