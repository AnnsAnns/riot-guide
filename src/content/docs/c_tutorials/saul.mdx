...
check if the sensor truly exists. To do this we create a simply if statement that checks 
...
Once again, RIOT provides a simple function to solve this problem,
